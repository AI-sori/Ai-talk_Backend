...
public class CommunityPostController {
    ...
    @PostMapping("/post")
    public ResponseEntity<CommonResponse<Void>> createPost(@ModelAttribute CommunityPostRequestDTO dto, @AuthenticationPrincipal Member loginUser) throws
        IOException {
    ...
    // 게시글 단건 조회 (DTO로 반환)
    @GetMapping("/{id}")
    public ResponseEntity<CommonResponse<CommunityPostResponseDTO>> getPost(@PathVariable Long id, @AuthenticationPrincipal(expression = "isAuthenticated() ? principal : null") Member loginUser) {
    ...
    public ResponseEntity<CommonResponse<Void>> likePost(@PathVariable Long postId, @AuthenticationPrincipal Member loginUser
    ) {
    ...
    public ResponseEntity<CommonResponse<Void>> unlikePost(@PathVariable Long postId, @AuthenticationPrincipal Member loginUser
    ) {
